    ...
    <div className="min-h-screen flex items-center justify-center bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 p-8">
        <div className="text-center">
          <h2 className="mt-6 text-4xl font-black tracking-tight text-gray-900">Sign in<span className="text-brand-red">.</span></h2>
        </div>
        <form className="mt-12 space-y-8" onSubmit={onSubmit}>
          ...
          <div className="text-base text-center mt-6">
            ...
            <Link to="/register" className="font-semibold text-gray-900 hover:text-brand-red transition-colors">
              Register here
            </Link>
          </div>
        </form>
